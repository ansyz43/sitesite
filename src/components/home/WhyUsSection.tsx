...
const WhyUsSection = () => {
  ...
  return (
    <section className="bg-section bg-why-us w-full min-h-screen flex items-center justify-center py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6 mx-auto">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-[#1a1a1a]/50 p-6 rounded-lg border border-gray-800 hover:border-[#E30613] transition-colors flex flex-col items-center"
            >
              {benefit.emoji && (
